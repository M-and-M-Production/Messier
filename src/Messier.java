...
public class Messier implements Comparable<Messier> {
    ...
    public class DistanceBounds {
         ...
         * </pre></blockquote>
         * @throws IllegalArgumentException if the string is not in the format "MIN-MAX" or "MIN" where MIN and MAX are doubles.
     ...
     * @return the difference between the magnitude of the Messier object and the other Messier object
     */
